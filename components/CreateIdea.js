        ...
        <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {errors.idea && (
                    <Alert variant="danger">
                        ...
                        {errors.idea?.type === "minLength" && (
                            <p>
                                La longueur maximale pour l'idée de cadeau est
                                de 60 caractères.
                            </p>
                        )}
                    </Alert>
            ...
            <div className={"form-group"}>
                <ToggleButtonGroup
                    ...
                    defaultValue={"public"}
                >
                    <ToggleButton variant="secondary" value={"public"}>
                        Publique
                    </ToggleButton>
                    <ToggleButton variant="secondary" value={"private"}>
                        Privée
                    </ToggleButton>
                </ToggleButtonGroup>
                <Alert variant={"warning"}>
                    Rendre une idée <strong>publique</strong> est recommandé !
                    L'idée de cadeau est anonymisée et peut-être échangée avec
