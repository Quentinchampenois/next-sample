        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-group">
                ...
                <Alert variant="danger">
                    { errors.name?.type === "required" && <p>Merci de renseigner le nom / prenom de votre ami.e</p> }
            ...
            <div className="form-group">
                ...
                { errors.number &&
                <Alert variant="danger">
                    { errors.number?.type === "required" && <p>Merci de renseigner votre idée de cadeau.</p> }
                </Alert>
                }
            </div>

            <Button
                type="submit" variant={"dark"} size={'lg'} block>Enregistrer mon ami.e
            </Button>
        </form>
    )
}