        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-group">
                <label htmlFor="pseudo">
                    Pseudonyme -{" "}
                    <small>
                        Le pseudo permettant de vous connecter à la plateforme
                    </small>
                </label>
                <input
                    // Register input
                ...
                {errors.pseudo && (
                    ...
                    <Alert variant="danger">
                        {errors.pseudo?.type === "required" && (
                            <p>Un pseudo est obligatoire.</p>
                        )}
                        {errors.pseudo?.type === "maxLength" && (
                            <p>
                                La longueur maximale du pseudo est de 30
                                caractères.
                            </p>
                        )}
                    </Alert>
                ...
                {errors.password && (
                    <Alert variant="danger">
                        {errors.password?.type === "required" && (
                            <p>
                                Un mot de passe est obligatoire pour vous
                                connecter à votre compte.
                            </p>
                        )}
                        {errors.password?.type === "minLength" && (
                            <p>
                                La longueur minimale du mot de passe est de 6
                                caractères.{" "}
                            </p>
                        )}
                    </Alert>
                ...
                {errors.passwordconf && (
                    <Alert variant="danger">
                        {errors.passwordconf?.type === "required" && (
                            <p>
                                Merci de renseigner à nouveau votre mot de
                                passe.
                            </p>
                        )}
                        {errors.passwordconf?.type === "validate" && (
                            <p>
                                Vos mots de passe semblent différent, merci de
                                renseigner exactement le même.
                            </p>
                        )}
                    </Alert>
                )}
